...
contract SimpleBank {
    ...
    function deposit() public payable returns (uint) {
        ...
        require(enrolled[msg.sender], 'Need to enroll first');
    ...
    function withdraw(uint withdrawAmount) public returns (uint) {
        ...
        require(enrolled[msg.sender], 'Unauthorized');
        require(withdrawAmount >= 0, 'Incorrect amount');
        require(balances[msg.sender] >= withdrawAmount, 'Not enough cash');
